...
<?php if (!isset($_GET['bearbeiten'])) {
    echo '<form class="form-horizontal form-label-left" id = "form-fin" action = "./func/submitproject.php" method = "post" >';
} else {
    echo '<form class="form-horizontal form-label-left" id = "form-fin" action = "./func/changeproject.php" method = "post" >';
}
?>
